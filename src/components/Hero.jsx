...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
   ...
   <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
    ...
    <div className={`flex flex-1 ${styles.flexCenter}  md:my-0 my-10 relative z-[5]`}>
      <img src={robot} alt="" className='w-[100%] h-[100%] relative z-[5]'/>
      <div className='absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient overflow-hidden'/>
      <div className='absolute z-[1] w-[80%] h-[80%] rounded-full bottom-40   overflow-hidden white__gradient'/>
      <div className='absolute z-[0] w-[50%] h-[50%] bottom-20 right-20 blue__gradient  overflow-hidden'/>
    </div>
